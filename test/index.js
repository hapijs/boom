...
describe('Boom', () => {
    ...
    describe('boomify()', () => {
        ...
        it('returns boom error unchanged', (done) => {
        ...
        it('overrides message and statusCode', (done) => {
        ...
        it('initializes plain error', (done) => {
