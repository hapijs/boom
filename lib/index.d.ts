...
export class Boom<Data = any> extends Error {
     ...
     */
    constructor(message?: string | Error, options?: Boom.BaseOptions<Data>);
     ...
     * @returns A 401 Unauthorized error
     */
    static unauthorized<Data>(message?: string | null): Boom<Data>;
     ...
     * @returns A 401 Unauthorized error
     */
    static unauthorized<Data>(message: '' | null, scheme: string, attributes?: string | Boom.unauthorized.Attributes): Boom<Data> & Boom.unauthorized.MissingAuth;
    static unauthorized<Data>(message: string | null, scheme: string, attributes?: string | Boom.unauthorized.Attributes): Boom<Data>;
     ...
     * @returns A 401 Unauthorized error
     */
    static unauthorized<Data>(message: string | null, wwwAuthenticate: string[]): Boom<Data>;
     ...
     * @returns A 405 Method Not Allowed error
     */
    static methodNotAllowed<Data>(message?: string, data?: Data, allow?: string | string[]): Boom<Data>;
     ...
     */
    static internal<Data>(message?: string, data?: Data, statusCode?: number): Boom<Data>;
...
export namespace Boom {
    ...
    interface Options<Data, Decoration> extends BaseOptions<Data> {
