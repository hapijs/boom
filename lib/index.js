...
internals.reformat = function () {
    ...
    this.response.payload.statusCode = this.response.statusCode;
    this.response.payload.error = Http.STATUS_CODES[this.response.statusCode] || 'Unknown';
    if (this.message) {
...
exports.internal = function (message, data, statusCode) {
    ...
    error.response.payload.message = 'An internal server error occurred';           // Hide actual error from user
    return error;
};
