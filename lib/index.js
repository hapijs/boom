...
module.exports = internals.Boom = class extends Error {
    ...
    static noContent(message, data) {
        ...
        return new internals.Boom(message, { statusCode: 204, data, ctor: internals.Boom.noContent });
    }
...
internals.initialize = function (err, statusCode, message) {
    ...
    Hoek.assert(!isNaN(numberCode) && numberCode >= 200, 'First argument must be a number (400+):', statusCode);
