...
exports.notImplemented = function (message, data) {
    ...
    return internals.internal(message, data, 501, exports.notImplemented);
};


exports.badGateway = function (message, data) {

    return internals.internal(message, data, 502, exports.badGateway);
};


exports.serverTimeout = function (message, data) {

    return internals.internal(message, data, 503, exports.serverTimeout);
};


exports.gatewayTimeout = function (message, data) {

    return internals.internal(message, data, 504, exports.gatewayTimeout);
};


exports.badImplementation = function (message, data) {

    var err = internals.internal(message, data, 500, exports.badImplementation);
