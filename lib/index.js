...
internals.statusError = function (statusCode, isServer) {

    const method = isServer ?
        function (message, data) {

            return internals.serverError(message, data, statusCode, method);
        } :
        function (message, data) {
...
exports.unauthorized = function (message, scheme, attributes) {          // Or (message, wwwAuthenticate[])
    ...
    if (!scheme) {
        return new exports.Boom(message, { statusCode: 401, ctor: exports.unauthorized });
    }
    ...
    if (typeof scheme !== 'string') {
        ...
        return new exports.Boom(message, { statusCode: 401, headers, ctor: exports.unauthorized });
    }
    ...
    return Object.assign(new exports.Boom(message, { statusCode: 401, headers, ctor: exports.unauthorized }), decorate);
};
...
exports.methodNotAllowed = function (message, data, allow) {
    ...
    return new exports.Boom(message, { statusCode: 405, data, headers, ctor: exports.methodNotAllowed });
};
...
exports.notImplemented = internals.statusError(501, true);


exports.badGateway = internals.statusError(502, true);


exports.serverUnavailable = internals.statusError(503, true);


exports.gatewayTimeout = internals.statusError(504, true);
