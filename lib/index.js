...
internals.extendOutput = function (obj) {

    // Underscore _.isObject
    var isObject = function(obj){return (typeof obj === 'function' || typeof obj === 'object' && !!obj)};
    ...
    return extend(this.output.payload, obj);
}
